                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <div className="ml-3 text-left">
                        <h3 className="font-semibold text-gray-900">Pay with KBZPay (PWA)</h3>
                        <p className="text-sm text-gray-600">Mobile wallet payment with browser</p>
                      </div>
                    </div>
