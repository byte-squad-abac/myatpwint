            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-red-700">
                  <p>
                    <strong>Please input all real information & contact myatpwint email if you have any inquiries.</strong>
                    Be careful with what you submit as rejected applications will result in a permanent ban from becoming an author on our platform.
                  </p>
                </div>
              </div>
            </div>
